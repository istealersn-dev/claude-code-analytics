          ...
          <div>
            ...
            <div className="flex">
              <input
                ...
                readOnly
              />
              <button className="bg-gray-600 hover:bg-gray-500 text-white px-4 py-2 rounded-r-lg font-medium transition-colors">
                Browse
              </button>
            </div>
      ...
      <div className="bg-background-secondary/50 border border-gray-700 rounded-lg p-6 mb-6">
        ...
        <div className="space-y-4">
          <div>
            ...
            <select className="w-full md:w-auto bg-background-primary border border-gray-600 rounded-lg px-3 py-2 text-white focus:border-primary-500 focus:outline-none">
