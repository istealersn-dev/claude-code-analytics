...
import { ArrowLeft, Clock, DollarSign, Hash, Zap, Wrench, User, Bot, Copy, ExternalLink } from 'lucide-react';
...
function SessionDetail() {
  ...
  const cacheEfficiency = session.cache_hit_count + session.cache_miss_count > 0 
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <StatsCard
          ...
          subtitle={session.tools_used.slice(0, 2).join(', ') + (session.tools_used.length > 2 ? '...' : '')}
          icon={Wrench}
          loading={false}
        />
